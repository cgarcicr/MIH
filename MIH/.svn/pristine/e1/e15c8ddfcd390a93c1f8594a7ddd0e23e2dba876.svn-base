...
@FacesConverter("CamposConverterE1")
@Named
public class CamposConverterE1 implements Converter{
	...
	private List<Campo> getCamposList(FacesContext facesContext) {       
        return getConsultaDinamicaBean(facesContext).getCamposE1();
    }
